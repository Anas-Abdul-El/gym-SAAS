    ...
    return (
        <>
                ...
                <div className='w-full h-90 flex flex-col items-center space-y-6'>
                    ...
                    <div className='text-center h-fit'>
                        <h1 className="text-5xl lg:text-7xl font-bold text-white">
                            ...
                            <span className="block bg-linear-to-r from-purple-400 via-violet-400 to-indigo-400 bg-clip-text text-transparent"> Modern Gyms</span>
                        </h1>
                    </div>
                            ...
                            <div className='w-full h-fit p-1' key={index}>
                                <div className={`w-full p-5 h-fit flex flex-col border ${ele.borderColor} ${ele.color} bg-linear-to-r rounded-lg space-y-5 px-4 group hover:scale-110 transition-transform`}>
                                    <div className='w-full h-10 '>
                                        <div className={`bg-linear-to-r w-fit h-fit p-3 rounded-lg border border-purple-500/20 ${ele.color}`}>
            ...
            <div className='w-full mt-25 flex justify-center'>
                <div className='w-9/10 flex justify-center items-center  space-y-6 flex-col from-violet-500/20 to-purple-500/20 bg-linear-to-r rounded-2xl p-7 py-10 mb-10'>
                    ...
                    <Button
                        className="w-8/10 sm:w-3/10 group px-8 py-7 bg-linear-to-r from-purple-600 to-violet-600 hover:from-purple-700
                         hover:to-violet-700 rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg shadow-purple-500/50"
