        ...
        <div className='w-full h-fit flex flex-col justify-end p-6 space-y-20 lg:w-9/10 mx-auto'>
            <div className='flex flex-col justify-center items-center w-full h-fit space-y-6 mt-30 text-center'>
                <div className="h-fit w-fit inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 backdrop-blur-sm">
                    ...
                    <span className="text-sm text-purple-300">We're Here to Help</span>
                </div>
                <h1 className='text-5xl md:text-6xl lg:text-7xl capitalize text-white flex flex-col space-y-5 font-bold leading-tight'>
                    Get in Touch
                    <span className='block bg-linear-to-r from-purple-400 via-violet-400 to-indigo-400 bg-clip-text text-transparent'>With Our Team</span>
                </h1>
            ...
            <div className='w-full grid lg:grid-cols-3 grid-cols-1 space-y-2 gap-13  text-white'>
                ...
                <div className="lg:col-span-1 flex flex-col space-y-6">
                        ...
                        <div>
                            {
                                help.map((ele, id) => (
                                    <div key={id} className="flex space-x-5 mb-8">
                                        <div className="p-3 w-fit h-fit bg-purple-600/10 rounded-sm border-purple-400/10 border-2">
                                            {<ele.icon size={20} className="text-purple-400" />}
                                        </div>
                    ...
                    <div className="w-full h-fit flex flex-col justify-center space-y-10 bg-purple-600/10 backdrop-blur-xl border border-white/10 rounded-2xl p-7">
                        <h1 className="text-2xl font-bold">How Can We Help?</h1>
