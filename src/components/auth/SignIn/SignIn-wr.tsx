...
function SignInWr() {
    ...
    return (
        <div className='w-full h-full flex flex-col items-center'>
            <div className='flex flex-col w-110  bg-white/5 backdrop-blur-xl border border-white/10 p-8 md:p-10 shadow-2xl rounded-2xl space-y-7 my-30 '>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className='h-23 flex flex-col'>
                                    ...
                                    <Mail size={21} className='absolute top-86 left-13 text-gray-500' />
                                    <FormControl>
                                        <Input
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className='h-23 flex flex-col'>
                                    ...
                                    <Lock size={21} className='absolute top-109 left-13 text-gray-500' />
                                    {
                                        view ? (
                                            <EyeOff size={21} className='absolute top-109 left-91 text-gray-500 cursor-pointer' onClick={() => setView(false)} />
                                        ) : (
                                            <Eye size={21} className='absolute top-109 left-91 text-gray-500 cursor-pointer' onClick={() => setView(true)} />
                                        )
                                    }
                                    <FormControl>
                                        <Input
                ...
                <div className='w-4/5 mx-auto flex space-x-1'>
